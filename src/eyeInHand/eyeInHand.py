...
if __name__ == '__main__':
    ...
    images_path = "/home/zyh/zyh_demo1/eyeInHand/images" #手眼标定采集的标定版图片所在路径
    file_path = "/home/zyh/zyh_demo1/eyeInHand/images/posescopy.txt" #采集标定板图片时对应的机械臂末端的位姿 从 第一行到最后一行 需要和采集的标定板的图片顺序进行对应
